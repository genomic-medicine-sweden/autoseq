...
- [ #91 ](https://github.com/genomic-medicine-sweden/autoseq/pull/91) Reference channels in `main.nf` now use `channelFromPathWithMeta`, and the `take:` block comments follow the `docs/CONTRIBUTING.md` style.
